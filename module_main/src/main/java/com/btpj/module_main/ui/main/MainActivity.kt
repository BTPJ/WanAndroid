package com.btpj.module_main.ui.main
...
import com.btpj.module_main.databinding.MainActivityMainBinding
 ...
 */
class MainActivity :
    BaseVMBActivity<MainViewModel, MainActivityMainBinding>(R.layout.main_activity_main) {
    ...
    override fun onBackPressed() {
        ...
        if (System.currentTimeMillis() - lastBackMills > 2000) {
            ...
            ToastUtil.showShort(this, getString(com.btpj.lib_base.R.string.toast_double_back_exit))
        } else {
            super.onBackPressed()
        }
    }
