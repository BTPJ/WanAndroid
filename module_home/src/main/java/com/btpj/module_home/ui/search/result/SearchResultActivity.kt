package com.btpj.module_home.ui.search.result
...
class SearchResultActivity :
    BaseVMBActivity<SearchResultViewModel, HomeActivitySearchResultBinding>(R.layout.home_activity_search_result) {
